...
import (
	...
	gcp "github.com/khulnasoft/casskube/mage/gcloud"
	ginkgo_util "github.com/khulnasoft/casskube/mage/ginkgo"
	integutil "github.com/khulnasoft/casskube/mage/integ-tests"
	k3d "github.com/khulnasoft/casskube/mage/k3d"
	kind "github.com/khulnasoft/casskube/mage/kind"
...
const (
	OperatorImage    = "khulnasoft/casskube:latest"
	OperatorImageUBI = "khulnasoft/casskube:latest-ubi"
...
func getOperatorImage() string {
	...
	if baseOs := os.Getenv(operator.EnvBaseOs); baseOs != "" {
		img = "khulnasoft/casskube:latest-ubi"
	} else {
		img = "khulnasoft/casskube:latest"
	}
	return img
}
...
func cleanupLingeringHelmResources() {
	_ = kubectl.DeleteByTypeAndName("clusterrole", "casskube-cluster-role").ExecV()
	_ = kubectl.DeleteByTypeAndName("clusterrolebinding", "casskube").ExecV()
	_ = kubectl.DeleteByTypeAndName("validatingwebhookconfiguration", "cassandradatacenter-webhook-registration").ExecV()
	_ = kubectl.DeleteByTypeAndName("crd", "cassandradatacenters.cassandra.khulnasoft.com").ExecV()
}
...
func SetupExampleCluster() {
	...
	ginkgo_util.HelmInstallWithOverrides("./charts/casskube-chart", namespace, overrides)
