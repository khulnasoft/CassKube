...
import (
	...
	webhook "github.com/khulnasoft/casskube/operator/pkg/admissionwebhook"
	"github.com/khulnasoft/casskube/operator/pkg/apis"
	"github.com/khulnasoft/casskube/operator/pkg/controller"
...
func main() {
	...
	err = leader.Become(ctx, "casskube-lock")
...
func readBaseOsIntoEnv() error {
	baseOsArgFilePath := "/var/lib/casskube/base_os"
