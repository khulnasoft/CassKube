...
func Test_makeImage(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:      "khulnasoft/dse-server:6.8.0",
			errString: "",
		},
		{
			...
			want:      "khulnasoft/cassandra-mgmtapi-3_11_7:v0.1.13",
			errString: "",
		},
		{
			name: "test private repo server",
			args: args{
				serverImage:   "khulnasoft.jfrog.io/secret-debug-image/dse-server:6.8.0-test123",
				serverType:    "dse",
				serverVersion: "6.8.0",
			},
			want:      "khulnasoft.jfrog.io/secret-debug-image/dse-server:6.8.0-test123",
			errString: "",
		},
		{
		...
		},
		{
			...
			want:      "khulnasoft/dse-server:6.8.1234",
			errString: "",
		},
		{
			...
			want:      "khulnasoft/cassandra-mgmtapi:3.11.1234",
			errString: "",
		},
		{
			name: "test 6.8.4",
			...
			want:      "khulnasoft/dse-server:6.8.4",
			errString: "",
		},
	}
...
func Test_makeUbiImage(t *testing.T) {
	...
	tests := []struct {
	...
	}{
		{
			...
			want:      "khulnasoft/dse-server:6.8.1234-ubi7",
			errString: "",
		},
		{
			name: "test cassandra fallback",
			...
			want:      "khulnasoft/cassandra-mgmtapi:4.0.1234-ubi7",
			errString: "",
		},
		{
			name: "test unknown dse version",
