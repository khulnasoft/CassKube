...
func GetOpenAPIDefinitions(ref common.ReferenceCallback) map[string]common.OpenAPIDefinition {
	return map[string]common.OpenAPIDefinition{
		"github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraDatacenter":       schema_pkg_apis_cassandra_v1beta1_CassandraDatacenter(ref),
		"github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraDatacenterSpec":   schema_pkg_apis_cassandra_v1beta1_CassandraDatacenterSpec(ref),
		"github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraDatacenterStatus": schema_pkg_apis_cassandra_v1beta1_CassandraDatacenterStatus(ref),
	}
}
...
func schema_pkg_apis_cassandra_v1beta1_CassandraDatacenter(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
		Schema: spec.Schema{
			SchemaProps: spec.SchemaProps{
				...
				Properties: map[string]spec.Schema{
					...
					"spec": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraDatacenterSpec"),
						},
					},
					"status": {
						SchemaProps: spec.SchemaProps{
							Ref: ref("github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraDatacenterStatus"),
						},
					},
				},
			},
		...
		Dependencies: []string{
			"github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraDatacenterSpec", "github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraDatacenterStatus", "k8s.io/apimachinery/pkg/apis/meta/v1.ObjectMeta"},
	}
}
...
func schema_pkg_apis_cassandra_v1beta1_CassandraDatacenterSpec(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
				...
				Properties: map[string]spec.Schema{
					...
					"managementApiAuth": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.ManagementApiAuthConfig"),
						},
					},
					"resources": {
						SchemaProps: spec.SchemaProps{
					...
					"racks": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.Rack"),
									},
								},
							},
						},
					...
					"storageConfig": {
						SchemaProps: spec.SchemaProps{
							...
							Ref:         ref("github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.StorageConfig"),
						},
					},
					"replaceNodes": {
						SchemaProps: spec.SchemaProps{
		...
		Dependencies: []string{
			"github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.ManagementApiAuthConfig", "github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.Rack", "github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.StorageConfig", "k8s.io/api/core/v1.PodTemplateSpec", "k8s.io/api/core/v1.ResourceRequirements"},
	}
}
...
func schema_pkg_apis_cassandra_v1beta1_CassandraDatacenterStatus(ref common.ReferenceCallback) common.OpenAPIDefinition {
	return common.OpenAPIDefinition{
					...
					"conditions": {
						SchemaProps: spec.SchemaProps{
							...
							Items: &spec.SchemaOrArray{
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.DatacenterCondition"),
									},
								},
							},
						},
					...
					"nodeStatuses": {
						SchemaProps: spec.SchemaProps{
							...
							AdditionalProperties: &spec.SchemaOrBool{
								...
								Schema: &spec.Schema{
									SchemaProps: spec.SchemaProps{
										Ref: ref("github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraNodeStatus"),
									},
								},
							},
						},
		...
		Dependencies: []string{
			"github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.CassandraNodeStatus", "github.com/khulnasoft/casskube/operator/pkg/apis/cassandra/v1beta1.DatacenterCondition", "k8s.io/apimachinery/pkg/apis/meta/v1.Time"},
	}
}
