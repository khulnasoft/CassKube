...
var imageLookupMap map[Image]string = map[Image]string{
	...
	Cassandra_3_11_6: "khulnasoft/cassandra-mgmtapi-3_11_6:v0.1.5",
	Cassandra_3_11_7: "khulnasoft/cassandra-mgmtapi-3_11_7:v0.1.13",
	Cassandra_4_0_0:  "khulnasoft/cassandra-mgmtapi-4_0_0:v0.1.12",

	UBICassandra_3_11_6: "khulnasoft/cassandra:3.11.6-ubi7",
	UBICassandra_3_11_7: "khulnasoft/cassandra:3.11.7-ubi7",
	UBICassandra_4_0_0:  "khulnasoft/cassandra:4.0-ubi7",

	DSE_6_8_0: "khulnasoft/dse-server:6.8.0",
	DSE_6_8_1: "khulnasoft/dse-server:6.8.1",
	DSE_6_8_2: "khulnasoft/dse-server:6.8.2",
	DSE_6_8_3: "khulnasoft/dse-server:6.8.3",
	DSE_6_8_4: "khulnasoft/dse-server:6.8.4",

	UBIDSE_6_8_0: "khulnasoft/dse-server:6.8.0-ubi7",
	UBIDSE_6_8_1: "khulnasoft/dse-server:6.8.1-ubi7",
	UBIDSE_6_8_2: "khulnasoft/dse-server:6.8.2-ubi7",
	UBIDSE_6_8_3: "khulnasoft/dse-server:6.8.3-ubi7",
	UBIDSE_6_8_4: "khulnasoft/dse-server:6.8.4-ubi7",

	ConfigBuilder:    "khulnasoft/cass-config-builder:1.0.3",
	UBIConfigBuilder: "khulnasoft/cass-config-builder:1.0.3-ubi7",
...
func GetCassandraImage(serverType, version string) (string, error) {
	...
	if !found {
		...
		if serverType == "dse" {
			...
			fallbackImageName = fmt.Sprintf("khulnasoft/dse-server:%s", version)
		} else {
			...
			fallbackImageName = fmt.Sprintf("khulnasoft/cassandra-mgmtapi:%s", version)
		}
