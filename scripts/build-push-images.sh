...
# GITHUB_REPO_URL - the GitHub repository url (i.e. https://github.com/khulnasoft/casskube)
# GITHUB_REPO_OWNER - the owner of the repository (i.e. khulnasoft), this is useful for forks
...
ECR_REPOSITORY="${ECR_REPO}/khulnasoft/casskube"
GH_REPOSITORY="docker.pkg.github.com/${GITHUB_REPO_OWNER}/casskube/operator"
